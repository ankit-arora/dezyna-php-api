...
class RewardTest extends TestCase {
	...
	public function testGrantReward() {
		...
		$r = $this->api->grant_reward('c', 100.001,"2013-12-07");
		$this->assertEquals(200, $r['status']);
		$this->assertEquals(100.00,$r['data']->value);
		$this->assertEquals('c',$r['data']->code);
		...
		$r = $this->api->grant_reward('c', 100.50,"2013-12-07","Order no 007");
		$this->assertEquals(200, $r['status']);
		...
		$r = $this->api->grant_reward('c', "ankit","2013-12-07","Order no 008");
